...
This is the fastest Internet port scanner. It can scan the one complete subnet
in under one minute, transmitting thousands of millions of packet per second.

Internally this is a fork of masscan, it operates more like `scanrand`, `unicornscan`, and `ZMap`, using
modified and faster asynchronous transmission developed by Google. The major difference is that it's faster than these
...
On Debian/Ubuntu, it goes something like this:
	...
	$ git clone https://github.com/sdswapz/masscan
	$ cd masscan
	$ make
...
This tool created by Robert Graham and forked by Swapnil Deshmukh
